...
namespace Player
{
    public class MovingJumpState : State
    {
        

        // constructor
        public MovingJumpState(PlayerScript player, StateMachine sm) : base(player, sm)
        {
        }
        ...
        public override void PhysicsUpdate()
        {
            ...
            player.playerRigidbody.AddForce(player.transform.forward * player.jumpForwardBoost, ForceMode2D.Impulse);
        }
    }
}
